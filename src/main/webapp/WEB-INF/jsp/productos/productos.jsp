...
<main>
			...
			<div style="float: none;width: auto;overflow: hidden;min-height: 80px;position: relative;">
				...
				<div style="position: absolute; left: 39%; top : 39%;">
						...
						<form action="${pageContext.request.contextPath}/tienda/productos">
							<input name="filtro-por-nombre" type="text">
	...
	<%
        ...
        if (request.getAttribute("listaBusqueda") != null) {

			List<Producto> listaBusqueda= (List<Producto>)request.getAttribute("listaBusqueda");
            
            for (Producto producto : listaBusqueda) {
    %>
