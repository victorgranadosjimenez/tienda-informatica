...
public class ProductosServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (pathInfo == null || "/".equals(pathInfo)) {
			...
			String busqueda = request.getParameter("filtro-por-nombre");

			if (busqueda != null) {
				request.setAttribute("listaBusqueda", prodDAO.getByFilter(busqueda));
				//request.setAttribute("listaBusqueda", prodDAO.getByFilterUsingFullTextIndex(busqueda));
			}else{
				request.setAttribute("listaBusqueda", prodDAO.getAll());
			}
